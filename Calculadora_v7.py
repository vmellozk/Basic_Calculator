...
while True:
    ...
    try:
        ...
        #Variáveis das operações foi declarado aqui para não ter nenhum problema com os valores
        ...
        result_potw = numberOne ** numberTwo
        result_rad = numberOne ** (1/numberTwo)
        result_porcent = (numberOne / numberTwo) * 100
        ...
        #Opção de Potenciação
        elif choice == "5":
            sleep(1)
            #Verifica e converte para inteiro
            if result_potw.is_integer():
                print(f"{numberOne} ** {numberTwo} = {result_potw}")
            else:
                #Trata as casas decimais
                print(f"{numberOne} ** {numberTwo} = {result_potw:.3f}")
